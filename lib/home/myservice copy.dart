...
class MyService extends StatefulWidget {
  String devicename;
  // String getDeviceName(dname) {
  //   return devicename = dname;
  // }
  ...
  MyService({String devicename, Key key}) : super(key: key);
            ...
            onPressed: () {
              setState(() {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => MyService(devicename: onscreen),
                  ),
                );
                print(onscreen);
              });
